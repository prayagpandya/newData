...
const TermsAndConditions = () => {
  return (
    <Box p="4">
      <Text mb="4">
        We employ the use of cookies. By accessing www.dataskillshub.com, you
        agreed to use cookies in agreement with the Data Skills Hub's Privacy
        Policy.
      </Text>
      <Text mb="4">
        These terms and conditions outline the rules and regulations for the use
        of Data Skills Hub's Website, located at https://dataskillshub.com.
      </Text>
      <Text mb="4">
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use www.dataskillshub.com if you do not
      ...
      <Text mb="4">
        Unless otherwise stated, Data Skills Hub and/or its licensors own the
        intellectual property rights for all material on www.dataskillshub.com.
        All intellectual property rights are reserved. You may access this from
        www.dataskillshub.com for your own personal use subjected to
        restrictions set in these terms and conditions.
      </Text>
      <Text mb="4">You must not:</Text>
      <UnorderedList mb="4" pl="4">
        <ListItem>Republish material from www.dataskillshub.com</ListItem>
        <ListItem>
          Sell, rent or sub-license material from www.dataskillshub.com
        </ListItem>
        <ListItem>
          Reproduce, duplicate or copy material from www.dataskillshub.com
        </ListItem>
        <ListItem>Redistribute content from www.dataskillshub.com</ListItem>
      </UnorderedList>
      <Text mb="4">
      ...
      <Text mb="4">
        ...
        exchange opinions and information in certain areas of the website. Data
        Skills Hub does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Data Skills Hub, its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Data Skills Hub
      ...
      <Text mb="4">
        Data Skills Hub reserves the right to monitor all Comments and to remove
        any Comments which can be considered inappropriate, offensive or causes
        breach of these Terms and Conditions.
      </Text>
      <Text mb="4">You warrant and represent that:</Text>
      <UnorderedList mb="4" pl="4">
        <ListItem>
      ...
      <Text mb="4">
        You hereby grant Data Skills Hub a non-exclusive license to use,
      ...
      <Text mb="4">
        ...
        the hyperlink compensates the absence of Data Skills Hub; and (d) the
      ...
      <Text mb="4">
        ...
        e-mail to Data Skills Hub. Please include your name, your organization
      ...
      <Text mb="4">
        No use of Data Skills Hub's logo or other artwork will be allowed for
      ...
      <Text mb="4">
        Our refund policy strictly states that we do not offer refunds for any
        course enrollments made on dataskillshub.com. Once a purchase is
        completed, it is considered final, and no refunds will be provided under
        any circumstances.
      </Text>
      <Text mb="4">
